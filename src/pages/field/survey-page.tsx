            ...
            <div className="space-y-10 lg:col-span-3">
              <Panel>
                ...
                <PanelBody className="space-y-4">
                  ...
                  <div>
                    <p className="mb-2 text-[14px] font-medium">Homeowner reference photos</p>
              ...
              <Panel>
                ...
                <PanelBody className="space-y-6">
                  <fieldset>
                    <legend className="mb-2 text-[14px] font-medium">Surface geometry</legend>
                    <div className="grid gap-4 sm:grid-cols-3">
                      ...
                      <div className="rounded-md bg-surface-2 px-3 py-2">
                        <p className="text-[13px] text-fg-2">Verified area</p>
                        <p className="tnum text-xl font-semibold">
                          {Number.isFinite(area) ? area.toFixed(2) : '0.00'} <span className="text-[13px] font-normal text-fg-2">m²</span>
                        </p>
                        <p className="tnum text-[13px] text-fg-3">
                          {delta >= 0 ? '+' : ''}
                  ...
                  <fieldset>
                    <legend className="mb-2 text-[14px] font-medium">Roof architectural profile</legend>
                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                      {data.profiles.map((p) => (
                        <label
                          key={p}
                          className={cx(
                            'press flex h-10 cursor-pointer items-center justify-center rounded-md border text-[15px]',
                  ...
                  <div>
                    <div className="mb-1.5 flex items-baseline justify-between">
                      <label htmlFor="tilt" className="text-[14px] font-medium">
                        Verified inclinometer tilt
                      </label>
                      <span className="tnum text-[15px]">
                        <span className="text-lg font-semibold">{tilt}°</span> <span className="text-fg-3">baseline 25°</span>
                      </span>
                    </div>
                    <input
                      id="tilt"
                    ...
                    />
                    <div className="tnum flex justify-between text-[13px] text-fg-3">
                  ...
                  <fieldset>
                    <legend className="mb-2 text-[14px] font-medium">Technician accessibility grade</legend>
                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                      {data.access.map((a) => (
                        <label
                          key={a.label}
                          className={cx(
                            'press cursor-pointer rounded-md border px-3 py-2 text-left',
                        ...
                        >
                          ...
                          <span className={cx('block text-[14px] font-medium', access === a.label && 'text-accent-fg')}>{a.label}</span>
                          <span className="block text-[13px] text-fg-3">{a.note}</span>
                        </label>
                      ))}
                    </div>
                  </fieldset>
                  ...
                  <fieldset>
                    <legend className="mb-2 text-[14px] font-medium">Identified shading and obstacles</legend>
                    <ul className="divide-y divide-line border-t border-b border-line">
                      {data.obstacles.map((o) => (
                        <li key={o.label} className="flex items-center justify-between gap-3 px-3 py-2.5">
                  ...
                  <div>
                    <div className="mb-2 flex items-center justify-between">
                      <p className="text-[14px] font-medium">Service panel compatibility</p>
              ...
              <Panel>
                ...
                <PanelBody className="space-y-4">
                  ...
                  >
                    ...
                    <span className="text-[13px] text-fg-3">High-res JPEG or RAW with embedded GPS coordinates</span>
                  </button>
          ...
          <div className="sticky bottom-0 z-10 mt-6 -mx-4 border-t border-line bg-canvas/95 px-4 py-3 backdrop-blur md:-mx-8 md:px-8">
            <div className="mx-auto flex max-w-[1320px] flex-wrap items-center gap-2">
              ...
              <div className="flex w-full flex-wrap items-center gap-3 sm:ml-auto sm:w-auto">
                <span className="tnum text-[14px] text-fg-2">
