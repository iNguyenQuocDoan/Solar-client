...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: ops.customers, element: <PlaceholderPage title="Customers" /> },
      { path: ops.surveys, element: <PlaceholderPage title="Surveys" /> },
      { path: ops.quotations, element: <PlaceholderPage title="Quotations" /> },
      { path: ops.contracts, element: <PlaceholderPage title="Contracts" /> },
      { path: ops.projects, element: <PlaceholderPage title="Projects" /> },
    ],
  },
  {
    path: field.home,
    ...
    children: [
      ...
      { path: field.warranty, element: <PlaceholderPage title="Warranty & Maintenance" /> },
      { path: field.schedule, element: <PlaceholderPage title="Schedule" /> },
      { path: field.notifications, element: <PlaceholderPage title="Notifications" /> },
      { path: field.profile, element: <PlaceholderPage title="Profile" /> },
    ],
  },
  {
    path: manage.home,
    ...
    children: [
      ...
      { path: manage.notifications, element: <PlaceholderPage title="Notifications" /> },
      { path: manage.profile, element: <PlaceholderPage title="Profile" /> },
    ],
  },
